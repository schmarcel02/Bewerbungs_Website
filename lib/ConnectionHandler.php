...
class ConnectionHandler
{
    ...
    public static function getConnection()
    {
        ...
        if (self::$connection === null) {
            ...
            $config = RootPath::root_require_once("config.php");
    ...
    public static function executeQuery($query, $param_types = "", ...$params)
    {
    ...
    public static function selectSpecific($column_name, $query, $param_types = "", ...$params)
    {
        $result = self::executeQuery($query, $param_types, ...$params);

        if (!$result) {
            throw new Exception("Query execution failed");
        }

        return $result->fetch_object()->$column_name;
    }

    public static function selectRow($query, $param_types = "", ...$params)
    {
        $result = self::executeQuery($query, $param_types, ...$params);
    ...
    public static function selectRows($query, $param_types = "", ...$params)
    {
        $result = self::executeQuery($query, $param_types, ...$params);
